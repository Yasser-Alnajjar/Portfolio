...
const skills = [
  {
    id: 1,
    skill: 'HTML',
    icon: <img className="img-fluid" src={html.src} alt="html" />,
    direction: '100',
  },
  {
    id: 2,
    skill: 'Css',
    icon: <img className="img-fluid" src={css.src} alt="css" />,
    direction: '-100',
  },
  {
    id: 3,
    skill: 'Javascript',
    icon: <img className="img-fluid" src={javascript.src} alt="javascript" />,
    direction: '100',
  },
  {
    id: 4,
    skill: 'Typescript',
    icon: <img className="img-fluid" src={typescript.src} alt="typescript" />,
    direction: '-100',
  },
  {
    id: 5,
    skill: 'React.js',
    icon: <img className="img-fluid" src={react.src} alt="react" />,
    direction: '100',
  },
  {
    id: 6,
    skill: 'Next.js',
    icon: <img className="img-fluid" src={next.src} alt="next" />,
    direction: '-100',
  },
  {
    id: 7,
    skill: 'Vue.js (Fundamentals)',
    icon: <img className="img-fluid" src={vue.src} alt="vue" />,
    direction: '100',
  },
  {
    id: 8,
    skill: 'Bootstrap',
    icon: <img className="img-fluid" src={bootstrap.src} alt="bootstrap" />,
    direction: '-100',
  },
  {
    id: 9,
    skill: 'Sass',
    icon: <img className="img-fluid" src={sass.src} alt="sass" />,
    direction: '100',
  },
  {
    id: 10,
    skill: 'Tailwind Css',
    icon: <img className="img-fluid" src={tailwind.src} alt="tailwind" />,
    direction: '-100',
  },
  {
    id: 11,
    skill: 'MUI',
    icon: <img className="img-fluid" src={mui.src} alt="mui" />,
    direction: '100',
  },
  {
    id: 12,
    skill: 'NPM',
    icon: <img className="img-fluid" src={npm.src} alt="npm" />,
    direction: '-100',
  },
  {
    id: 13,
    skill: 'Vite',
    icon: <img className="img-fluid" src={vite.src} alt="vite" />,
    direction: '100',
  },
  {
    id: 14,
    skill: 'Webpack',
    icon: <img className="img-fluid" src={webpack.src} alt="webpack" />,
    direction: '-100',
  },
  {
    id: 15,
    skill: 'Git',
    icon: <img className="img-fluid" src={git.src} alt="git" />,
    direction: '100',
  },
  {
    id: 16,
    skill: 'Github',
    icon: <img className="img-fluid" src={github.src} alt="github" />,
    direction: '-100',
  },
  {
    id: 17,
    skill: 'vercel',
    icon: <img className="img-fluid" src={vercel.src} alt="vercel" />,
    direction: '100',
  },
];
